        ...
        child: Scaffold(
              ...
              return SpeedDial(
                ...
                children: [
                  SpeedDialChild(
                      ...
                      label: container.read(languageProvider).isEnglish == null
                          ? "Kurye değiştir"
          ...
          appBar: AppBar(
            title: Row(
              children: [
                Text(
                  container.read(languageProvider).isEnglish==null?"Çanta listesi":
            ...
            bottom: TabBar(
              tabs: [
                Tab(
                  ...
                  text:container.read(languageProvider).isEnglish==null?"Kuryedekiler": container.read(languageProvider).isEnglish! ? "On The Courier" : "Auf dem Fahrer",
                ),
                Tab(
                  icon: Icon(Icons.warehouse_outlined),
                  text: container.read(languageProvider).isEnglish==null?"Depodakiler":container.read(languageProvider).isEnglish! ? "In the warehouse" : "Lagerhaus",
                ),
              ],
              onTap: (value) {
                context.read(bagListProvider).selectIndex(-1);
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return Container(
                                  ...
                                  child: GestureDetector(
                                    onTap: () async {
                                      if (context.read(bagListProvider).selectedIndex != index) {
                              ...
                              Row(
                                ...
                                children: [
                                  ElevatedButton(
                                      ...
                                      onPressed: () {},
                                      child: Text(
                                       container.read(languageProvider).isEnglish==null?"Kuryeye ver": container.read(languageProvider).isEnglish!
                        ...
                        return Container(
                          ...
                          child: Center(
                            ...
                            children: [
                              ...
                              Text(container.read(languageProvider).isEnglish==null?"Depoda çanta yok":
                                container.read(languageProvider).isEnglish!
