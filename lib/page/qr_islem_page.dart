  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          container.read(languageProvider).isEnglish==null?"Çanta işlemleri":
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                          ...
                          child: SizedBox(
                            ...
                            height: 50,
                            child: Center(
                              child: Text( container.read(languageProvider).isEnglish==null?"Depoya al":container.read(languageProvider).isEnglish!
                                      ? "Put it in warehouse."
                                      : "Lagern Sie es ein.",
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            if (context.read(bagListProvider).cantaVer()[context.read(bagListProvider).selectedBagQr] ==
                             ...
                             showSimpleNotification(
                                  Text(container.read(languageProvider).isEnglish==null?"Çanta bulunamadı":container.read(languageProvider).isEnglish!
                                      ? "bag not found."
                          ...
                          child: SizedBox(
                            ...
                            height: 50,
                            child: Center(
                              child: Text(container.read(languageProvider).isEnglish==null?"Kuryeye ver":container.read(languageProvider).isEnglish!
