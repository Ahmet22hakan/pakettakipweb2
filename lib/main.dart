...
void main() async {
  ...
  if (storage.hasData("lang")) {
    if (storage.read("lang") == null) {
      container.read(languageProvider).changeLanguage(null);
    } else {
      if (storage.read("lang")) {
        container.read(languageProvider).changeLanguage(true);
      } else {
        container.read(languageProvider).changeLanguage(false);
      }
    }
  }
